...
static inline ervp_task_wait_fx_t dca_matrix_mac_wait_fx(const dca_matrix_mac_hwinfo_t *const hwinfo)
{
...
{
  task_wait_finish(dca_matrix_mac_wait_fx(hwinfo));
}
...
static inline ervp_task_wait_fx_t dca_matrix_add(ervp_mop_mapping_t *mop_mapping, const dca_matrix_mac_hwinfo_t *const hwinfo, const ErvpMatrixInfo *ma_info, const ErvpMatrixInfo *mb_info, ErvpMatrixInfo *mc_info, unsigned int option_value)
{
  return dca_matrix_mac_start(mop_mapping, hwinfo, DCA_MAC_ADD, ma_info, mb_info, mc_info, option_value);
}

static inline ervp_task_wait_fx_t dca_matrix_sub(ervp_mop_mapping_t *mop_mapping, const dca_matrix_mac_hwinfo_t *const hwinfo, const ErvpMatrixInfo *ma_info, const ErvpMatrixInfo *mb_info, ErvpMatrixInfo *mc_info, unsigned int option_value)
{
  return dca_matrix_mac_start(mop_mapping, hwinfo, DCA_MAC_SUB, ma_info, mb_info, mc_info, option_value);
}

static inline ervp_task_wait_fx_t dca_matrix_ewmult(ervp_mop_mapping_t *mop_mapping, const dca_matrix_mac_hwinfo_t *const hwinfo, const ErvpMatrixInfo *ma_info, const ErvpMatrixInfo *mb_info, ErvpMatrixInfo *mc_info, unsigned int option_value)
{
  return dca_matrix_mac_start(mop_mapping, hwinfo, DCA_MAC_EWMULT, ma_info, mb_info, mc_info, option_value);
}

static inline ervp_task_wait_fx_t dca_matrix_mult(ervp_mop_mapping_t *mop_mapping, const dca_matrix_mac_hwinfo_t *const hwinfo, const ErvpMatrixInfo *ma_info, const ErvpMatrixInfo *mb_info, ErvpMatrixInfo *mc_info, unsigned int option_value)
{
