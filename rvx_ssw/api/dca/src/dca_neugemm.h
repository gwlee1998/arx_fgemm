...
static inline ervp_task_wait_fx_t dca_neugemm_wait_fx(const dca_neugemm_hwinfo_t *const hwinfo)
{
...
{
  task_wait_finish(dca_neugemm_wait_fx(hwinfo));
}
...
static inline ervp_task_wait_fx_t dca_neugemm_add(ervp_mop_mapping_t *mop_mapping, const dca_neugemm_hwinfo_t *const hwinfo, const ErvpMatrixInfo *ma_info, const ErvpMatrixInfo *mb_info, ErvpMatrixInfo *mc_info, unsigned int option_value)
{
  return dca_neugemm_start(mop_mapping, hwinfo, DCA_NEUGEMM_ADD, ma_info, mb_info, mc_info, option_value);
}

static inline ervp_task_wait_fx_t dca_neugemm_sub(ervp_mop_mapping_t *mop_mapping, const dca_neugemm_hwinfo_t *const hwinfo, const ErvpMatrixInfo *ma_info, const ErvpMatrixInfo *mb_info, ErvpMatrixInfo *mc_info, unsigned int option_value)
{
  return dca_neugemm_start(mop_mapping, hwinfo, DCA_NEUGEMM_SUB, ma_info, mb_info, mc_info, option_value);
}

static inline ervp_task_wait_fx_t dca_neugemm_ewmult(ervp_mop_mapping_t *mop_mapping, const dca_neugemm_hwinfo_t *const hwinfo, const ErvpMatrixInfo *ma_info, const ErvpMatrixInfo *mb_info, ErvpMatrixInfo *mc_info, unsigned int option_value)
{
  return dca_neugemm_start(mop_mapping, hwinfo, DCA_NEUGEMM_EWMULT, ma_info, mb_info, mc_info, option_value);
}

static inline ervp_task_wait_fx_t dca_neugemm_mult(ervp_mop_mapping_t *mop_mapping, const dca_neugemm_hwinfo_t *const hwinfo, const ErvpMatrixInfo *ma_info, const ErvpMatrixInfo *mb_info, ErvpMatrixInfo *mc_info, unsigned int option_value)
{
