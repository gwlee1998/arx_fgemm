...
static inline int _matrix_get_element_addr_offset_in_row(const ErvpMatrixInfo *matrix, int col_index)
{
...
{
  return _matrix_get_element_addr_offset_in_row(matrix, col_index);
}
