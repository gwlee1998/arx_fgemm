...
static ervp_task_wait_fx_t __matrix_copy_part_sw(const ErvpMatrixInfo *a, ErvpMatrixInfo *c, int num_row, int num_col, unsigned int option_value)
{
...
static ervp_task_wait_fx_t __matrix_transpose_part_sw(const ErvpMatrixInfo *a, ErvpMatrixInfo *c, int num_row, int num_col, unsigned int option_value)
{
  assert(_mop_option_check(c, option_value));
  assert(mop_option_is_acc(option_value) == 0);
  ervp_mop_option_t mop_option = mop_option_alloc(option_value);
