...
ervp_task_wait_fx_t _matrix_fill_fixed_sw(ervp_mop_mapping_t* mop_mapping, ErvpMatrixInfo *result, int32_t value)
{
  UNKNOWN_TYPE data;
...
ervp_task_wait_fx_t _matrix_fill_float_sw(ervp_mop_mapping_t* mop_mapping, ErvpMatrixInfo *result, float value)
{
  UNKNOWN_TYPE data;
...
ervp_task_wait_fx_t _matrix_identity_sw(ervp_mop_mapping_t* mop_mapping, ErvpMatrixInfo *result)
{
  UNKNOWN_TYPE value;
  int min_size;
