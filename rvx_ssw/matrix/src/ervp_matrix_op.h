...
typedef union
{
  ...
  struct
  {
    ...
    unsigned int pad_mode_zeros : 1;
    unsigned int pad_mode_replicate : 1;
...
typedef union
{
  ...
  struct
  {
    unsigned int num_rowu : 4;
    unsigned int num_rowd : 4;
    unsigned int num_colu : 4;
    unsigned int num_cold : 4;
    unsigned int mode_zeros : 1;
    unsigned int mode_replicate : 1;
  } br;
} ervp_mpad_option_t;
...
{
  ervp_task_wait_fx_t (*matrix_copy_part)(ervp_mop_mapping_t *mop_mapping, const ErvpMatrixInfo *a, ErvpMatrixInfo *c, int num_row, int num_col, unsigned int option_value);
  ervp_task_wait_fx_t (*matrix_transpose_part)(ervp_mop_mapping_t *mop_mapping, const ErvpMatrixInfo *a, ErvpMatrixInfo *c, int num_row, int num_col, unsigned int option_value);
  ervp_task_wait_fx_t (*matrix_reshape)(ervp_mop_mapping_t *mop_mapping, const ErvpMatrixInfo *a, ErvpMatrixInfo *c, unsigned int option_value);

  ervp_task_wait_fx_t (*matrix_add)(ervp_mop_mapping_t *mop_mapping, const ErvpMatrixInfo *a, const ErvpMatrixInfo *b, ErvpMatrixInfo *c, unsigned int option_value);
  ervp_task_wait_fx_t (*matrix_sub)(ervp_mop_mapping_t *mop_mapping, const ErvpMatrixInfo *a, const ErvpMatrixInfo *b, ErvpMatrixInfo *c, unsigned int option_value);
  ervp_task_wait_fx_t (*matrix_ewmult)(ervp_mop_mapping_t *mop_mapping, const ErvpMatrixInfo *a, const ErvpMatrixInfo *b, ErvpMatrixInfo *c, unsigned int option_value);
  ervp_task_wait_fx_t (*matrix_mult)(ervp_mop_mapping_t *mop_mapping, const ErvpMatrixInfo *a, const ErvpMatrixInfo *b, ErvpMatrixInfo *c, unsigned int option_value);
  ervp_task_wait_fx_t (*matrix_conv)(ervp_mop_mapping_t *mop_mapping, const ErvpMatrixInfo *a, const ErvpMatrixInfo *b, ErvpMatrixInfo *c, unsigned int conv_option_value);
  ervp_task_wait_fx_t (*matrix_conv_sharedinput)(ervp_mop_mapping_t *mop_mapping, int num_output, const ErvpMatrixInfo *input_info, const ErvpMatrixInfo **kernel_info_list, ErvpMatrixInfo **output_info_list, unsigned int conv_option_value);
  ervp_task_wait_fx_t (*matrix_conv_sharedoutput)(ervp_mop_mapping_t *mop_mapping, int num_input, const ErvpMatrixInfo **input_info_list, const ErvpMatrixInfo **kernel_info_list, ErvpMatrixInfo *output_info, unsigned int conv_option_value, int init_output);

  ervp_task_wait_fx_t (*matrix_scalar_mult_fixed)(ervp_mop_mapping_t *mop_mapping, const ErvpMatrixInfo *a, int scalar_value, ErvpMatrixInfo *c, unsigned int option_value);
  ervp_task_wait_fx_t (*matrix_scalar_mult_float)(ervp_mop_mapping_t *mop_mapping, const ErvpMatrixInfo *a, float scalar_value, ErvpMatrixInfo *c, unsigned int option_value);
  ervp_task_wait_fx_t (*matrix_shift_fixed)(ervp_mop_mapping_t *mop_mapping, const ErvpMatrixInfo *a, int shamount, ErvpMatrixInfo *c, unsigned int option_value);
  ervp_task_wait_fx_t (*matrix_perform_postprocess)(ervp_mop_mapping_t *mop_mapping, const ErvpMatrixInfo *a, ErvpMatrixInfo *c, unsigned int option_value);
  ervp_task_wait_fx_t (*matrix_pad)(ervp_mop_mapping_t *mop_mapping, const ErvpMatrixInfo *a, ErvpMatrixInfo *c, unsigned int pad_option_value);
  ...
  ervp_task_wait_fx_t (*matrix_copy)(ervp_mop_mapping_t *mop_mapping, const ErvpMatrixInfo *a, ErvpMatrixInfo *c, unsigned int option_value);
  ervp_task_wait_fx_t (*matrix_transpose)(ervp_mop_mapping_t *mop_mapping, const ErvpMatrixInfo *a, ErvpMatrixInfo *c, unsigned int option_value);
...
// ervp_mconv_option_t
static inline unsigned int matrix_conv_set_pad(unsigned int conv_option_value, int pad_amount)
{
...
static inline unsigned int matrix_conv_has_pad(unsigned int conv_option_value)
{
  ervp_mconv_option_t conv_option;
  conv_option.value = conv_option_value;
  return (conv_option.br.pad_amount > 0) && (conv_option.br.pad_has_rowd || conv_option.br.pad_has_rowu || conv_option.br.pad_has_cold || conv_option.br.pad_has_colu);
}
...
static inline int matrix_conv_output_rows(int input_row, int kernel_row, unsigned int conv_option_value)
{
  ervp_mconv_option_t conv_option;
  conv_option.value = conv_option_value;
  return ((input_row + (conv_option.br.pad_amount * (conv_option.br.pad_has_rowd + conv_option.br.pad_has_rowu)) - kernel_row) / (conv_option.br.stride_m1 + 1)) + 1;
}
...
static inline int matrix_conv_output_cols(int input_col, int kernel_col, unsigned int conv_option_value)
{
  ervp_mconv_option_t conv_option;
  conv_option.value = conv_option_value;
  return ((input_col + (conv_option.br.pad_amount * (conv_option.br.pad_has_cold + conv_option.br.pad_has_colu)) - kernel_col) / (conv_option.br.stride_m1 + 1)) + 1;
}
