...
ervp_task_wait_fx_t matrix_copy2copy_part_tf(ervp_mop_mapping_t *mop_mapping, const ErvpMatrixInfo *a, ErvpMatrixInfo *c, unsigned int option_value)
{
  assert(matrix_is_same_size(a, c));
  return mop_mapping->matrix_copy_part(mop_mapping, a, c, a->num_row, a->num_col, option_value);
}

ervp_task_wait_fx_t matrix_transpose2transpose_part_tf(ervp_mop_mapping_t *mop_mapping, const ErvpMatrixInfo *a, ErvpMatrixInfo *c, unsigned int option_value)
{
...
ervp_task_wait_fx_t matrix_conv2mult_im2col(ervp_mop_mapping_t *mop_mapping, const ErvpMatrixInfo *input_info, const ErvpMatrixInfo *kernel_info, ErvpMatrixInfo *output_info, unsigned int conv_option_value)
{
...
ervp_task_wait_fx_t matrix_conv2mult_v1_tf(ervp_mop_mapping_t *mop_mapping, const ErvpMatrixInfo *input_info, const ErvpMatrixInfo *kernel_info, ErvpMatrixInfo *output_info, unsigned int conv_option_value)
{
  ...
  if (conv_option.br.performs_cliping || conv_option.br.rshift)
  {
    ...
    mop_mapping->matrix_perform_postprocess(mop_mapping, temp_info, output_info, mop_option.value);
...
ervp_task_wait_fx_t matrix_perform_postprocess_tf(ervp_mop_mapping_t *mop_mapping, const ErvpMatrixInfo *a, ErvpMatrixInfo *c, unsigned int option_value)
{
  assert(mop_mapping);
  ervp_mop_option_t mop_option = mop_option_alloc(option_value);
  ervp_task_wait_fx_t task_wait_fx = NULL;
  if (mop_option.br.rshift || mop_option.br.performs_cliping)
  {
  ...
  else
  {
    if (mop_option.br.acc)
    {
      ...
      task_wait_fx = mop_mapping->matrix_add(mop_mapping, a, c, c, 0);
    }
    else
    {
      if (a->addr != c->addr)
        task_wait_fx = mop_mapping->matrix_copy(mop_mapping, a, c, 0);
    }
  }
  return task_wait_fx;
}

ervp_task_wait_fx_t matrix_conv_sharedinput_tf(ervp_mop_mapping_t *mop_mapping, int num_output, const ErvpMatrixInfo *input_info, const ErvpMatrixInfo **kernel_info_list, ErvpMatrixInfo **output_info_list, unsigned int conv_option_value)
{
  ervp_task_wait_fx_t task_wait_fx = NULL;
  for (int i = 0; i < num_output; i++)
    mop_mapping->matrix_conv(mop_mapping, input_info, kernel_info_list[i], output_info_list[i], conv_option_value);
  return task_wait_fx;
}

ervp_task_wait_fx_t matrix_conv_sharedoutput_tf(ervp_mop_mapping_t *mop_mapping, int num_input, const ErvpMatrixInfo **input_info_list, const ErvpMatrixInfo **kernel_info_list, ErvpMatrixInfo *output_info, unsigned int conv_option_value, int init_ouptut)
{
  ervp_mconv_option_t conv_option;
  conv_option.value = conv_option_value;
  ...
  for (int i = 0; i < num_input; i++)
  {
    ...
    task_wait_fx = mop_mapping->matrix_conv(mop_mapping, input_info_list[i], kernel_info_list[i], output_info, conv_option_value);
  }
  return task_wait_fx;
}
...
ervp_task_wait_fx_t matrix_conv_sharedinput_im2col(ervp_mop_mapping_t *mop_mapping, int num_output, const ErvpMatrixInfo *input_info, const ErvpMatrixInfo **kernel_info_list, ErvpMatrixInfo **output_info_list, unsigned int conv_option_value)
{
  // printf_function();
  ...
  task_wait_fx = mop_mapping->matrix_mult(mop_mapping, flattened_kernel_info, reordered_input_info, merged_output_info, mop_option.value);
...
ervp_task_wait_fx_t matrix_padfill2copy_tf(ervp_mop_mapping_t *mop_mapping, const ErvpMatrixInfo *a, ErvpMatrixInfo *c, unsigned int pad_option_value)
{
...
ervp_task_wait_fx_t matrix_pad2copy_tf(ervp_mop_mapping_t *mop_mapping, const ErvpMatrixInfo *a, ErvpMatrixInfo *c, unsigned int pad_option_value)
{
  assert(matrix_pad_check_size(a, c, pad_option_value));
  ...
  matrix_padfill2copy_tf(mop_mapping, a, c, pad_option_value);
}