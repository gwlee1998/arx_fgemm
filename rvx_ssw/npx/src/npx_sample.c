...
npx_rawinput_t *npx_load_sample(const char *filename, const char *pre_fname)
{
  ...
  if ((strcmp(input_str, "mnist_dataset") == 0) || (strcmp(input_str, "fmnist_dataset") == 0))
  {
    npx_sample = npx_load_mnist_dataset(filename);
  }
  else if ((strcmp(input_str, "cifar10_dataset") == 0) || (strcmp(input_str, "gtsrb_dataset") == 0))
  {
    npx_sample = npx_load_cifar10_dataset(filename);
  }
  else if (strcmp(input_str, "dvsgesture_dataset") == 0)
  {
